...
import { analyzeSituation }
  from "@/services/psychologyAnalyzer";
...
import {
  validateMessage,
} from "@/filters/messageFilter";

import {
  detectSpam,
} from "@/security/antiSpam";
...
} from "@/security/requestCooldown";

import {
  saveMemory,
  getMemory,
  MemoryItem,
} from "@/memory/psychologyMemory";
  ...
  useEffect(() => {
    ...
    async function initialize() {
      ...
      */
      ...
      const remaining =
        await getRemainingQueriesFromDB(
          id
        );
    ...
    */
    ...
    if (
      ...
      setResponse({
        ...
        explanation:
          `Debes esperar ${cooldown.remaining} segundos antes de realizar otro análisis.`,
    ...
    if (!validation.valid) {
      ...
      setResponse({
        ...
        guidance:
          "Modifica tu mensaje e inténtalo nuevamente.",
      ...
      <div className="relative z-10 w-full max-w-3xl border border-cyan-500/30 bg-black/60 backdrop-blur-md rounded-3xl p-8 shadow-[0_0_40px_rgba(0,255,255,0.15)]">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-cyan-300/80 mt-4 text-center max-w-xl">
            ...
            Analiza patrones emocionales manipulativos,
            gaslighting y control psicológico.
        ...
        {remainingQueries <= 0 && (
          ...
          <div className="mt-6 border border-red-500/40 bg-red-500/10 rounded-2xl p-4 text-center">
            ...
            <p className="text-red-300 text-sm mt-2">
              ...
              Tus consultas se restaurarán automáticamente
              a medianoche hora Colombia.
